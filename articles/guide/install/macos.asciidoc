...
Read more from https://aws.amazon.com/corretto/

. Download and run the *Amazon Corretto 11* macOS installer (.pkg)
+
link:https://corretto.aws/downloads/latest/amazon-corretto-11-x64-macos-jdk.pkg[Download Amazon Corretto 11, role="button"]
